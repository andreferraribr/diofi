...
ll <- data.frame("ug_cliente_limite" = unique(limite$ug_cliente))
rr <- data.frame("ug_cliente_repasse" = unique(repasse$ug_cliente))
cc <- data.frame("ug_cliente_credito" = unique(credito$ug_cliente))
