...
rep_lim <- full_join(repasse %>% group_by(fonte_det_cod) %>% summarise(repasse = as.integer( sum(saldo))), limite %>% group_by(fonte_det_cod) %>% summarise(limite = as.integer( sum(saldo))))
